    ...
    <body>
        <div class="container" style="margin: auto; padding: 5% 10%; min-height: 600px; background-size: cover; background-image: url('https://i.postimg.cc/4ywDr9fc/photo-1574629810360-7efbbe195018.jpg')">
            <div class="row text-center" style="height: 50%;">
                <a class="col-xl-4 col-sm-6 mb-5" href="<?php print 'http://' . $_SERVER['HTTP_HOST'] . '/addFirst.php'; ?>" style="color: inherit;
 text-decoration: inherit;">
                    <div class="rounded shadow-sm py-5 px-4">
                        <h5 class="mb-0">Add D&G</h5>
                    </div>
                </a>
                <a class="col-xl-4 col-sm-6 mb-5" href="<?php print 'http://' . $_SERVER['HTTP_HOST'] . '/lookup.php'; ?>" style="color: inherit;
 text-decoration: inherit;">
                    <div class="rounded shadow-sm py-5 px-4">
                        <h5 class="mb-0">Lookup D&Gs</h5>
                    </div>
                </a>
                <a class="col-xl-4 col-sm-6 mb-5" href="<?php print 'http://' . $_SERVER['HTTP_HOST'] . '/other.php';?>" style="color: inherit;
 text-decoration: inherit;">
                    <div class="rounded shadow-sm py-5 px-4">
